	...
	<thead>
		<tr><th style="width: 90px;">操作</th>
			...
			<th><?php echo $this->Paginator->sort('status', array(
					'asc' => $this->BcBaser->getImg('admin/blt_list_down.png', array('alt' => '昇順', 'title' => '昇順')).' 利用',
					'desc' => $this->BcBaser->getImg('admin/blt_list_up.png', array('alt' => '降順', 'title' => '降順')).' 利用'),
					array('escape' => false, 'class' => 'btn-direction')) ?>
			</th>
...
<?php if(!empty($datas)): ?>
	<?php foreach($datas as $data): ?>
		<?php $this->BcBaser->element('petit_blog_custom_fields/index_row', array('data' => $data)) ?>
	<?php endforeach; ?>
<?php else: ?>
	<tr>
